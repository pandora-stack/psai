...
STACK_VERSION="1.0.3"
STACK_CHANNEL="beta"                  # release channel; shown as "v1.0.3 beta"
STACK_VERSION_TAG="v1.0.3_beta"       # git/version tag form
...
OPENHANDS_SANDBOX_IMAGE_SUFFIX="openhands_sandbox:1.0.3"
